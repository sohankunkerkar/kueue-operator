...
// apply.
func KueueStatus() *KueueStatusApplyConfiguration {
	return &KueueStatusApplyConfiguration{}
}

// WithObservedGeneration sets the ObservedGeneration field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ObservedGeneration field is set to the value of the last call.
func (b *KueueStatusApplyConfiguration) WithObservedGeneration(value int64) *KueueStatusApplyConfiguration {
...
func (b *KueueStatusApplyConfiguration) WithConditions(values ...*v1.OperatorConditionApplyConfiguration) *KueueStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *KueueStatusApplyConfiguration) WithVersion(value string) *KueueStatusApplyConfiguration {
...
func (b *KueueStatusApplyConfiguration) WithReadyReplicas(value int32) *KueueStatusApplyConfiguration {
...
func (b *KueueStatusApplyConfiguration) WithLatestAvailableRevision(value int32) *KueueStatusApplyConfiguration {
...
func (b *KueueStatusApplyConfiguration) WithGenerations(values ...*v1.GenerationStatusApplyConfiguration) *KueueStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
